            ...
            if feature in processed_data_for_features.columns:
                ...
                if feature in CATEGORICAL_FEATURES:
                    ...
                    user_val_str = st.text_input(
                        ...
                        key=f"input_{feature}_text",
                        help=current_tooltip
                    )

                    if feature == 'age' and user_val_str.lower() == 'love':
                        st.balloons()
                        st.markdown(
                            """
                            <div style='text-align: center; background-color: #ffe0f0; padding: 20px; border-radius: 10px; border: 2px solid #ff69b4;'>
                                <h2>Rico <span style='color: #ff69b4;'>&lt;3</span> Nta</h2>
                                <h3>I Love You Sayangku</h3>
                            </div>
                            """,
